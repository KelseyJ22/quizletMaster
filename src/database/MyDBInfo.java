...
{
	//Please be nice to my database :)
	public static final String MYSQL_USERNAME = "ccs108seokho";
	public static final String MYSQL_PASSWORD = "xongoodu";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_seokho";
